      ...
      <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <div className={`w-full flex-grow lg:flex lg:items-center lg:w-auto mt-2 lg:mt-0 ${isMenuOpen ? 'block' : 'hidden'} bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20`} id="nav-content">
          <ul className="list-reset lg:flex justify-end flex-1 items-center">
            <li className="mr-3">
              <Link to="/admin/dashboard" className="inline-block py-2 px-4 text-blue-600 font-bold hover:text-blue-500 no-underline">Tableau de bord</Link>
            </li>
            {/* <li className="mr-3">
              <Link to="/admin/statistique" className="inline-block text-blue-600 no-underline font-bold hover:text-blue-500 hover:text-underline py-2 px-4">Statistiques</Link>
            </li> */}
            <li className="mr-3">
